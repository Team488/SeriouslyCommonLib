package xbot.common.controls.actuators.gazebo_adapters;
...
public class CANTalonGazeboAdapter extends XCANTalon {

    @Inject
    public CANTalonGazeboAdapter(@Assisted("deviceId") int deviceId, XPropertyManager propMan, DevicePolice police) {
