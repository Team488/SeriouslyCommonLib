...
import xbot.common.controls.sensors.mock_adapters.MockAnalogInput.MockAnalogInputFactory;
import xbot.common.controls.sensors.mock_adapters.MockCANCoder.MockCANCoderFactory;
import xbot.common.controls.sensors.mock_adapters.MockDigitalInput.MockDigitalInputFactory;
...
public abstract class MockDevicesModule {
    ...
    @Binds
    @Singleton
    public abstract XCANLightController.XCANLightControllerFactory getLightControllerFactory(MockCANLightController.MockCANLightControllerFactory impl);
}
