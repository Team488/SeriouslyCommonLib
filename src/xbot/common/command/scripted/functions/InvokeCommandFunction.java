...
public class InvokeCommandFunction extends ScriptedCommandFunctionBase {
    ...
    private Consumer<BaseCommand> notifyInvokedCommand;
    private ScriptedCommand parentCommand;
    
    public InvokeCommandFunction(ScriptedCommandProvider commandToInvoke, Consumer<BaseCommand> notifyInvokedCommand, ScriptedCommand parentCommand) {
    ...
    public Object call(Context arg0, Scriptable arg1, Scriptable arg2, Object[] parameters) {
        try {
            BaseCommand newCommand = wrappedCommandType.get(parameters);
