...
/**
 * Ensures that joystick buttons are only used once and not assigned to multiple commands by
 * accident.
 */
public class JoystickButtonManager {

	private static final Logger log = Logger
			.getLogger(JoystickButtonManager.class);
	...
	public JoystickButtonManager(int numButtons, WPIFactory factory,
			XJoystick joystick) {
